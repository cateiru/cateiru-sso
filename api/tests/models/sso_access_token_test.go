...
func TestDeleteSSOAccessTokenByAccessToken(t *testing.T) {
	config.TestInit(t)
	...
	err = models.DeleteAccessTokenByAccessToken(ctx, db, entity.SSOAccessToken)
	require.NoError(t, err)
...
func TestDeleteAccessTokenByUserAndClientId(t *testing.T) {
	config.TestInit(t)
	...
	err = models.DeleteAccessTokenByUserIdAndClientId(ctx, db, dummy.UserID, entity.ClientID)
	require.NoError(t, err)
