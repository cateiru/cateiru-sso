...
var (
	emailVerifySessionDBTypes = map[string]string{`ID`: `varchar`, `UserID`: `varchar`, `VerifyCode`: `char`, `SendCount`: `tinyint`, `Period`: `datetime`, `RetryCount`: `tinyint`, `Created`: `datetime`, `Modified`: `datetime`}
	_                         = bytes.MinRead
)
