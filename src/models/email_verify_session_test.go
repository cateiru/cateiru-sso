...
var (
	emailVerifySessionDBTypes = map[string]string{`ID`: `varchar`, `UserID`: `varchar`, `NewEmail`: `varchar`, `VerifyCode`: `char`, `Period`: `datetime`, `RetryCount`: `tinyint`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`}
	_                         = bytes.MinRead
)
