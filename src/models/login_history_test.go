...
var (
	loginHistoryDBTypes = map[string]string{`ID`: `int`, `UserID`: `varbinary`, `RefreshID`: `varbinary`, `Device`: `varchar`, `Os`: `varchar`, `Browser`: `varchar`, `IsMobile`: `tinyint`, `IP`: `varbinary`, `Created`: `datetime`}
	_                   = bytes.MinRead
)
