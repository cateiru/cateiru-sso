...
var (
	passkeyDBTypes = map[string]string{`UserID`: `varbinary`, `WebauthnUserID`: `varbinary`, `Credential`: `text`, `PublicKey`: `text`, `IsBackupState`: `tinyint`, `Created`: `datetime`, `Modified`: `datetime`}
	_              = bytes.MinRead
)
