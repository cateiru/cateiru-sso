...
var (
	refreshDBTypes = map[string]string{`ID`: `varchar`, `UserID`: `varchar`, `HistoryID`: `varbinary`, `SessionID`: `varchar`, `Period`: `datetime`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`}
	_              = bytes.MinRead
)
