...
var (
	registerOtpSessionDBTypes = map[string]string{`ID`: `varchar`, `UserID`: `varchar`, `PublicKey`: `text`, `Secret`: `text`, `Period`: `datetime`, `RetryCount`: `tinyint`, `Created`: `datetime`, `Modified`: `datetime`}
	_                         = bytes.MinRead
)
