...
var (
	registerOtpSessionDBTypes = map[string]string{`ID`: `varchar`, `UserID`: `varbinary`, `PublicKey`: `text`, `Secret`: `text`, `Period`: `datetime`, `RetryCount`: `tinyint`, `Created`: `datetime`, `Modified`: `datetime`}
	_                         = bytes.MinRead
)
