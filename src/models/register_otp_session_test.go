...
var (
	registerOtpSessionDBTypes = map[string]string{`ID`: `varbinary`, `UserID`: `varbinary`, `PublicKey`: `text`, `Secret`: `text`, `Period`: `datetime`, `RetryCount`: `tinyint`, `Created`: `datetime`, `Modified`: `datetime`}
	_                         = bytes.MinRead
)
