...
var (
	userDBTypes = map[string]string{`ID`: `varchar`, `UserName`: `varchar`, `Email`: `varchar`, `FamilyName`: `text`, `MiddleName`: `text`, `GivenName`: `text`, `Gender`: `char`, `Birthdate`: `date`, `Avatar`: `text`, `LocaleID`: `char`, `Created`: `datetime`, `Modified`: `datetime`}
	_           = bytes.MinRead
)
