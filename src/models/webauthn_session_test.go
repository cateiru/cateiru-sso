...
var (
	webauthnSessionDBTypes = map[string]string{`ID`: `varbinary`, `WebauthnUserID`: `varchar`, `UserDisplayName`: `text`, `Challenge`: `text`, `UserVerification`: `varchar`, `Row`: `json`, `Period`: `datetime`, `Created`: `datetime`, `Modified`: `datetime`}
	_                      = bytes.MinRead
)
